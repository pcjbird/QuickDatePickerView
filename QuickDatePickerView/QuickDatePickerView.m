...
#import "QuickDatePickerView.h"
#import "QuickDatePickerViewDefine.h"

@interface QuickDatePickerView()<UIPickerViewDelegate,UIPickerViewDataSource,UIGestureRecognizerDelegate>
{
    NSString *_formatter;
...
@property (nonatomic,assign)QuickDateStyle dateStyle;
...
@implementation QuickDatePickerView
...
-(instancetype)initWithDateStyle:(QuickDateStyle)dateStyle complete:(QuickDatePickerViewBlock)complete
{
    if (self = [super init]) {
        ...
        switch (dateStyle)
        {
            case QuickDateStyle_YearMonthDayHourMinute:
            {
                _formatter = @"yyyy-MM-dd HH:mm";
            }
                break;
            case QuickDateStyle_MonthDayHourMinute:
            {
                _formatter = @"yyyy-MM-dd HH:mm";
            }
                break;
            case QuickDateStyle_YearMonthDay:
            {
                _formatter = @"yyyy-MM-dd";
            }
                break;
            case QuickDateStyle_YearMonth:
            {
                _formatter = @"yyyy-MM";
            }
                break;
            case QuickDateStyle_MonthDay:
            {
                _formatter = @"yyyy-MM-dd";
            }
                break;
            case QuickDateStyle_HourMinute:
            {
                _formatter = @"HH:mm";
            }
                break;
